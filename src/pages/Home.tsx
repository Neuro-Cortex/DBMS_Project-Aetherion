...
// ============================================
// 🎯 SPLINE 3D HERO - FULL INTERACTIVE
// ============================================
const SplineHeroSection: React.FC = () => {
  const navigate = useNavigate();

  return (
    <section className="relative min-h-screen bg-[#050508] overflow-hidden">
      {/* Spline 3D Background - Full Interactive Access */}
      <div className="absolute inset-0 z-0" style={{ pointerEvents: 'auto' }}>
        <Spline 
          scene="https://prod.spline.design/DHNkl78BlqWly1Rx/scene.splinecode"
          style={{ width: '100%', height: '100%', pointerEvents: 'auto' }}
        />
      </div>

      {/* Gradient Overlays - Only edges, center transparent for interaction */}
      <div className="absolute inset-0 z-10 pointer-events-none bg-gradient-to-r from-[#050508]/90 via-[#050508]/10 to-transparent" />
      <div className="absolute inset-0 z-10 pointer-events-none bg-gradient-to-t from-[#050508] via-transparent to-[#050508]/40" />

      {/* Content */}
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-screen flex items-center">
        <div className="max-w-2xl pointer-events-auto">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.03] border border-white/[0.06] text-white/40 text-xs font-medium mb-8 backdrop-blur-sm">
              <Sparkles className="w-3.5 h-3.5 text-cyan-400" />
              AI-Powered Healthcare Platform
            </div>

            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white tracking-[-0.04em] mb-6 leading-[0.9]">
              Healthcare
              <br />
            ...
            <p className="text-lg sm:text-xl text-white/40 max-w-xl mb-10 leading-relaxed">
              ...
              3D medical visualization, and instant access to 500+ specialists.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              <motion.button
                ...
                className="px-8 py-4 bg-white text-black font-semibold rounded-2xl text-base hover:bg-white/90 transition-all shadow-xl shadow-white/5 flex items-center gap-2"
              >
                Get Started Free
              ...
              <motion.button
                ...
                className="px-8 py-4 bg-red-500/10 text-red-400 font-semibold rounded-2xl text-base border border-red-500/20 hover:bg-red-500/20 transition-all flex items-center gap-2"
              >
            ...
            <div className="flex flex-wrap items-center gap-6 mt-10 text-white/25 text-sm">
      ...
      <div className="absolute bottom-8 right-8 z-20 hidden lg:flex items-center gap-3 bg-black/40 backdrop-blur-xl rounded-full px-5 py-3 border border-white/[0.06] pointer-events-none">
      ...
      <div className="absolute bottom-24 left-1/2 -translate-x-1/2 z-20 lg:hidden flex items-center gap-2 bg-black/40 backdrop-blur-xl rounded-full px-4 py-2.5 border border-white/[0.06] pointer-events-none">
        <span className="text-white/40 text-xs">👆 Drag & Pinch to interact</span>
      </div>
...
const FooterSection: React.FC = () => {
  return (
    <footer className="bg-[#030305] text-gray-300 py-12 border-t border-white/[0.04]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-500 text-sm">Complete healthcare ecosystem for modern medical needs.</p>
          </div>
          <div>
            <h4 className="text-white font-semibold mb-4 text-sm uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to="/doctors" className="text-gray-500 hover:text-white transition-colors">Find Doctors</Link></li>
              <li><Link to="/hospitals" className="text-gray-500 hover:text-white transition-colors">Hospitals</Link></li>
              <li><Link to="/pharmacy" className="text-gray-500 hover:text-white transition-colors">Pharmacy</Link></li>
              <li><Link to="/blood-donors" className="text-gray-500 hover:text-white transition-colors">Blood Donors</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-semibold mb-4 text-sm uppercase tracking-wider">Services</h4>
            <ul className="space-y-2 text-sm">
              <li><Link to="/emergency" className="text-gray-500 hover:text-white transition-colors">Emergency</Link></li>
              <li><Link to="/ai-assistant" className="text-gray-500 hover:text-white transition-colors">AI Assistant</Link></li>
              <li><Link to="/women-health" className="text-gray-500 hover:text-white transition-colors">Women Health</Link></li>
              <li><Link to="/oxygen-network" className="text-gray-500 hover:text-white transition-colors">Oxygen Network</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-white/[0.04] pt-8 text-center">
          <p className="text-gray-600 text-sm">&copy; 2024 Aetherion Health. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
