...
import Spline from '@splinetool/react-spline'; // ✅ Spline Import Added
import {
    ...
    <div className="min-h-screen bg-[#050508]">
      <div className="max-w-[2000px] mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <motion.div
          ...
          className="bg-[#060610] border border-white/[0.06] rounded-2xl overflow-hidden"
        >
          <div className="flex items-center justify-between p-6 border-b border-white/[0.06]">
            <div>
              <h3 className="text-white font-semibold text-lg">3D Medical Visualization</h3>
              <p className="text-white/30 text-xs mt-1">Interactive 3D view with AI-powered insights</p>
            </div>
            <div className="flex items-center gap-2">
              <button className="px-4 py-2 bg-white/[0.04] hover:bg-white/[0.08] border border-white/[0.08] rounded-xl text-white/60 hover:text-white text-xs transition-all">Reset View</button>
              <button className="px-4 py-2 bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/20 rounded-xl text-cyan-400 text-xs transition-all">Full Screen</button>
            </div>
          </div>
          <div className="h-[500px] lg:h-[600px] relative">
            <Spline scene="https://prod.spline.design/GDudo0Tah3uXby9A/scene.splinecode" />
            <div className="absolute inset-0 pointer-events-none bg-gradient-to-t from-[#060610] via-transparent to-transparent" />
          </div>
          <div className="flex items-center justify-between p-4 border-t border-white/[0.06]">
            <div className="flex items-center gap-4 text-white/30 text-xs">
              <span className="flex items-center gap-1"><span className="w-2 h-2 bg-cyan-400 rounded-full animate-pulse" />Interactive 3D</span>
              <span>Drag to rotate</span><span>•</span><span>Scroll to zoom</span>
            </div>
            <div className="flex items-center gap-1 text-emerald-400 text-xs">
              <span className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse" />Live 3D View
            </div>
          </div>
        </motion.div>
