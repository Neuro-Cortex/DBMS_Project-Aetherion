...
import {
  ...
  Activity, Shield, ChevronRight, Star,
    ...
    <div className="min-h-screen bg-[#050508]">
      ...
      <div className="ml-64 p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">AI-powered personalized health suggestions</p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <motion.div
            ...
            className="col-span-3 p-6 rounded-2xl bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 border border-cyan-500/20"
          >
              ...
              <div className="grid grid-cols-3 gap-3">
                {recommendations.foods.recommend.map((food, index) => (
                  ...
                  >
                    ...
                    <p className="text-white/40 text-xs mt-1">{food.reason}</p>
                  </motion.div>
                ))}
              </div>
            </motion.div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/40 text-xs mt-1">{tip.description}</p>
                    </div>
                  </div>
                </motion.div>
              ))}
            ...
            {[
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-white/60 text-sm">{med.time}</span>
                  {med.status === 'taken' ? (
                ...
                <p className="text-white/40 text-xs mt-1">{med.instructions}</p>
                {med.status === 'upcoming' && (
